        ...
        <div className="tab-content">
          <div id="home" className=" tab-pane active">
                          ...
                          <div className="col-md-10 mx-auto text-center">
                            <div>
                              ...
                              <p className="leads">
                                ...
                                all areas of our company, across our two
                  ...
                  <div className="col-md-10 mx-auto text-center">
                    <div className="services">
                      <p className="heading-color-icon">
                        <b>
                          {" "}
                          These business units are supported by our Group
                          Services:
                        </b>
                      </p>
                    </div>
                  ...
                  <div className="col-12 col-md-10 mx-auto">
                    <div className="row py-4">
                      ...
                      <div className="col-6 col-md text-center">
                        ...
                        <div className="txt">Human Resources</div>
                      </div>
                      <div className="col-6 col-md text-center">
                        <div className="icon-round">
                          <span>
                      ...
                      <div className="col-6 col-md text-center">
                        ...
                        <div className="txt">Marketing and Communications</div>
                      </div>
                      <div className="col-6 col-md text-center">
                        <div className="icon-round">
                          <span>
            ...
            <div className="leadership-height">
              <h1
                className="leadership-heading-color text-center"
                  ...
                  <div className="row ">
                    <div className="col-md-12 flexing-column">
                      <div className="img-container-div">
                        <img
                          src={item.img}
                          className="img-styling  img-leader-box-shadowing"
                        />
                      </div>

                      <div className="col-md-10">
                        <h6 className="heading-color-align margin-leader">
                          {item.title}
                        </h6>
                        <h1 className="align-leaders-name  margin-leader">
                          {item.name}
                        </h1>
                        <p className="text-color-pixel  margin-leader">
                          {item.body}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col-md-6 " style={{ paddingLeft: "50px" }}>
                    <div style={{ marginLeft: "40px", marginTop: "90px" }}>
                      ...
                      <p style={{ fontSize: "20px" }}>
                        ...
                        <br />
                        determination and passion of our
                        <br />
                        people.
                      </p>
                      <p
                      ...
                      >
                        Throughout our history we know our people make a
                        difference. Our team is talented, client-focused and
                        empowered to respond safely, efficiently and decisively.
                      </p>
                ...
                <div className="row">
                  <div className="col p-3">
                    <p
                      ...
                      style={{ color: "#7C7C7C", padding: "10px" }}
                    >
                      <b>
                        G&S is built on the foundations of honesty and
                        integrity. Our core values are the basis of our culture
                        and driver of <br /> our strategies
                      </b>
                    </p>
                  </div>
                </div>
                ...
                <div className="row row-container row-padding">
                  ...
                  <div className="col-6 col-md text-center">
                    <div className="icon-round">
                      ...
                      <h5
                        className="pt-md-5 pb-5 pb-md-0"
                        style={{ color: "#989899" }}
                      >
                ...
                <div className="row" style={{ padding: "50px" }}>
                  <div className="col-md-6">
                    ...
                    <div style={{ marginLeft: "40px", marginTop: "90px" }}>
                      ...
                      <p style={{ fontSize: "20px" }}>
                        G&S is succesful,sustainable and
                        <br />
                        an enjoyable place to work, through
                        <br />
                      ...
                      <p
                        ...
                        className="text-muted"
                      >
                        Our teams are made up of people who are committed to
                        their own and others safety and wellbeing. People who
                        want to deliver the highest possible standards and
                        successful outcomes for our clients. We foster a culture
                        of making the workplace enjoyable through a positive
                        approach and a desire to have fun at work.{" "}
                      </p>
                      <div style={{ paddingTop: "20px" }}>
