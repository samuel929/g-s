                                      ...
                                      <div id="carouselExampleIndicators" className="carousel slide">
                                           <div className="carousel-inner">
                                                <div className="carousel-item active">
                                                    <div className="page-header-home header-filter" data-parallax="true">
                                                             ...
                                                             <div className="row">
                                                                 <div className="col-md-8 mr-auto text-left">
                                                                      <div className="position-relative py-1">
                                                                          ...
                                                                          <p style={{fontSize:'32px',color:'white',paddingRight:'5px',paddingTop:'35px'}}>
                                                                            Your asset performance partner from<br/> the Earth’s surface down.
                                                                            </p>
                                                                      </div>
                                                                 </div>
                                                             </div>
