            ...
            <div className="row">
              <div className="col-md-10 mx-auto text-center">
                ...
                <p className="lead-2">
                  ...
                  port construction projects, G&S Engineering offer
                  comprehensive services that encompass the project lifestyle
            ...
            <div className="parent">
              ...
              <div className="card-body">
                <div style={{ maxWidth: "100%" }}>
                  ...
                  <h6 className=" mb-4 service-font ">
                    Calibre agrees to sell
                    <span className="g-s-yellow"> G&S Engineering</span> to
                    <span className="g-s-yellow"> DRA</span>
                  </h6>
                  <Link to="/services">
                    <YellowButton className="btn-style">READ MORE</YellowButton>{" "}
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="parent">
              ...
              <div className="card-body">
                <div className="content">
                  ...
                  <h6 className=" mb-4 service-font">
                    <span className="get-to-know-color">Get to know </span>us a
                    little better
                  </h6>
                </div>
                <Link to="/about">
                  <GreenButton className="btn-style">VIEW ABOUT US</GreenButton>{" "}
                </Link>
              </div>
            </div>
          </div>
              ...
              <div className="card-body">
                <div className="content">
                  ...
                  <h6 className=" mb-4 service-font">
                    ...
                    <span className="color-blue">join us</span>
                  </h6>
                </div>
                <Link to="/careers">
                  <BlueButton>VIEW ABOUT US</BlueButton>{" "}
                </Link>
              </div>
            </div>
          </div>
