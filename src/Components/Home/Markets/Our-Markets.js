                   ...
                   <h1 className="aligning-text" >OUR MARKETS</h1> 
                              ...
                              <div className="col-6 col-md text-center">
                                    <div className="icon-round">
                                          ...
                                          <Link className="link-to" to="/metals-minerals"><h5 className="pt-md-5 pb-5 pb-md-0">Metals & Minerals</h5></Link>
                                    </div>
                              </div>
                        ...
                        <Link to="/markets"><BlueButton>VIEW ALL MARKETS</BlueButton></Link>   
                        </div>
             </div>
        </div>
    )
