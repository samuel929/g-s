                                    ...
                                    <div className="row card-blog">
                                       <div className="col-md-4">
                                           <div>
                                             ...
                                             <h6 className="card-catergory" style={{color:'#213b71'}}><small>PROJECT: SHUT DOWN</small></h6>
                                               <p className="card-text-styling"><b>Caval Ridge Dragline 17 Major Shutdown</b></p>
                                              <div className="card-description">
                                              <p className="text-muted"><small>Like so many organizations these days, Autodesk is a company in transition. It was until recently a traditional</small></p>
                                              </div>
